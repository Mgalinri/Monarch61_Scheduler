      ...
      <div name="popup" class="bg-white rounded-lg shadow-lg w-1/3 relative w-[50rem]">
        ...
        <div name="popup-content" class="flex flex-col gap-4 p-6 px-8">
          ...
          <div name="top-icons" class="flex flex-row gap-4 justify-between">
            <span class="flex flex-col gap-4">
              ...
              <UBadge v-if="eventObj.spaces_available== 0 && !isEventScheduled() " color="rose" variant="solid" size="md">Max capacity reached</UBadge>
            </span>
        ...
        <div class="flex flex-row justify-end pb-6 px-8 gap-6">
          ...
          <button
            ...
            :class="{ 'bg-red-200 pointer-events-none': !eventObj.spaces_available && !isEventScheduled() }"
...
<script setup>
  ...
  const isEventScheduled = () => {
    ...
    return eventObj.dateId in userStore.getScheduledEvents()
  }
